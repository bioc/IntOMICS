...
#' preprocessed IntOMICSr input data
#'
#' The output from IntOMICSr::OMICS_module function. A named list containing preprocessed input data.
#'
#' @format A named list with 6 components:
#' \describe{
#'   \item{pf_UB_BGe_pre}{output from IntOMICSr::pf_UB_est function}
...
#' IntOMICSr first adaption phase result
#'
#' The output from IntOMICSr::first_adapt_phase function. A named list containing results from the MCMC sampling of the first adaption phase.
#'
...
#' IntOMICSr MCMC simulation result
#'
#' The output from IntOMICSr::BN_module function. A named list containing results from the MCMC sampling (resulting sample is thinned and converted into corresponding CPDAGs)
#'
#' @format A named list with 3 components:
#' \describe{
#'   \item{B_prior_mat_weighted}{IntOMICSr estimated empirical biological knowledge}
